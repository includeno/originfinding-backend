...
CREATE TABLE `copyright`  (
    ...
    `url` bigint(20) NULL DEFAULT NULL COMMENT '唯一网页地址',
...
DROP TABLE IF EXISTS `copyright_request`;
CREATE TABLE `copyright_request`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT '用户ID',
  `url` bigint(20) NULL DEFAULT NULL COMMENT '网页地址',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `url_index`(`url`) USING BTREE COMMENT 'url Index',
) ENGINE = InnoDB CHARSET=utf8mb4 COMMENT = '版权提交记录表';