...
import com.originfinding.service.URLValidService;
...
public class MatchHelper {
     ...
     public final static List<ClassPair> methodList=getMethodList(URLValidService.class);
    ...
    public static void listPackages(String basePackage, List<String> classes) {
        URL url = URLValidService.class.getClassLoader()
