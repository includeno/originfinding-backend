package com.originfinding.algorithm.hanlp;
...
//https://www.cnblogs.com/sanmubird/p/7966154.html
@Slf4j
@Data
public class HanlpSimHash {
    private String tokens; //字符串
    private BigInteger strSimHash;//字符产的hash值
    private int hashbits = 64; // 分词后的hash数;

    public HanlpSimHash(String tokens) {
        this.tokens = tokens;
        this.strSimHash = this.simHash();
    }

    public HanlpSimHash(String tokens, int hashbits) {
        this.tokens = tokens;
    ...
    private BigInteger simHash() {
        ...
        log.info("token:"+this.tokens.hashCode()+" =>"+new Gson().toJson(wordCount));
     ...
     * @return
     */
    public static int hammingDistance(HanlpSimHash from, HanlpSimHash to) {
    ...
    public static double getSemblance(HanlpSimHash a, HanlpSimHash b){
        double i = (double) HanlpSimHash.hammingDistance(a,b);
        return 1 - i/a.getHashbits() ;
    }
    ...
    public static void main(String[] args) {
        ...
        HanlpSimHash hash1 = new HanlpSimHash(s1, 64);
        HanlpSimHash hash2 = new HanlpSimHash(s2, 64);
        HanlpSimHash hash3 = new HanlpSimHash(s3, 64);
        HanlpSimHash hash4 = new HanlpSimHash(s4, 64);
        System.out.println("======================================");
        System.out.println(  HanlpSimHash.hammingDistance(hash1,hash2) );
        System.out.println(  HanlpSimHash.hammingDistance(hash2,hash3) );
        System.out.println(  HanlpSimHash.hammingDistance(hash4,hash3) );
        System.out.println(  HanlpSimHash.getSemblance(hash1,hash3) );
        System.out.println(  HanlpSimHash.getSemblance(hash2,hash3) );
        System.out.println(  HanlpSimHash.getSemblance(hash3,hash4) );
